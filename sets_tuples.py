...
# print(6 in set1)
# print("apple" in set2)
# #you cannot acess elements in a set by index because sets are unordered
# #instead you can covert the set to a list and access elements by index
# list1= list(set1)
# print(list1[0])
...
# print(set1.remove(6))
# print(set2.remove("apple"))
# print(set3.remove("banana"))
# print(set4.remove(5))
